...
const workerDays = [
  {
    ...
    articles: [
      ...
      {
        title: "외국인 투자자, 한국 주식 순매도 확대",
        summary: "환율 불안과 기업 부실 우려가 겹치며 외국인 자금 이탈 속도가 빨라지고 있습니다.",
        source: "한경마켓",
      },
      {
        title: "대기업 자금 조달 비용 상승",
        summary: "회사채 금리가 뛰면서 부채가 많은 기업의 유동성 부담이 커지고 있습니다.",
        source: "매일경제",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        title: "한국은행, 시장 안정 대책 검토",
        summary: "환율 방어와 금융시장 안정을 위해 추가 조치 가능성이 논의되고 있습니다.",
        source: "중앙경제",
      },
      {
        title: "기업 구조조정 압박 본격화",
        summary: "구제금융 조건에 따라 부실 기업 정리와 인력 감축 우려가 커지고 있습니다.",
        source: "조선일보",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      {
        title: "은행권 대출 심사 강화",
        summary: "금융기관들이 위험 관리를 강화하며 기업과 가계의 자금 조달이 더 어려워지고 있습니다.",
        source: "중앙경제",
      },
      {
        title: "직장인 투자자, 현금 확보 문의 증가",
        summary: "고용 불안과 주가 하락이 동시에 나타나며 투자금 일부를 현금화하려는 움직임이 늘고 있습니다.",
        source: "머니레슨",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: "금리와 재정 긴축이 이어질 경우 기업 실적과 고용 회복이 늦어질 수 있다는 분석입니다.",
        source: "한경마켓",
      },
      {
        title: "외환시장 변동성 여전히 높아",
        summary: "구제금융 합의에도 원화 가치가 안정되기까지는 시간이 필요하다는 전망이 나옵니다.",
        source: "글로벌마켓워치",
      },
    ],
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        summary: "시장 반등과 별개로 기업 감원과 사업 매각 뉴스가 계속 나오고 있습니다.",
        source: "조선일보",
      },
      {
        title: "반등장에서도 분산 투자 필요",
        summary: "전문가들은 단기 반등에만 기대기보다 현금과 위험자산 비중을 함께 점검하라고 조언합니다.",
        source: "머니레슨",
      },
    ],
  },
